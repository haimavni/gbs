...
export class GroupManager {
    ...
    add_or_update_contact(contact_data) {
        ...
        this.dialog.open({
            ...
            model: {
                curr_contact: this.curr_contact,
            ...
            .then((result) => {
                this.contact_list = this.contact_list.filter(
                    (contact) =>
                        ...
                        contact.group_id != this.curr_group_id
                );
            });
    }
    ...
    upload_logo(group, event: Event) {
        ...
        this.api.uploadFiles(this.user.id, group.logo_images, "GROUPLOGO", {
            group_id: group.id,
    ...
    delete_group(group) {
        this.api
            ...
            .then((result) => {
                let idx = this.group_list.findIndex(
                    (grp) => grp.id == group.id
                );
    ...
    get mail_params() {
        if (this.curr_group_id) {
            ...
            return {
                ...
                group_description: this.curr_group.description,
                link: link,
            };
        } else {
            return {};
