...
export class ArticleDetail {
    ...
    refresh_story(data) {
        ...
        let story = this.article.article_stories.find(
    ...
    attached() {
        this.sub1 = this.eventAggregator.subscribe(
            "EditModeChange",
            (payload: any) => {
                (this as any).user = payload;
            }
        );
        this.sub2 = this.eventAggregator.subscribe("DirtyStory", (dirty: any) => {
            this.dirty_story = dirty;
        });
        this.sub3 = this.eventAggregator.subscribe("DirtyInfo", (dirty: any) => {
        ...
        this.dialog
            ...
            .whenClosed((response) => {
                if (
                    ...
                    this.article.article_info.story_id =
                        (response.value as any).story_id;
    ...
    _set_heights() {
        ...
        let no_article_stories = this.article
