...
export class App {
    ...
    async configureRouter(config, router) {
        ...
        config.map([
            ...
            {route: 'videos', moduleId: './videos/videos_2', nav: true, title: 'videos.videos', settings: {auth: true}},
            ...
            {route: 'annotate-video/:id', name: 'annotate-video', moduleId: './videos/annotate-video', settings: {auth: true}},
