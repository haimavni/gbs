...
export class fitTextCustomElement {
    ...
    getLineHeight() {
        const lineHeight = window.getComputedStyle(this.element)['line-height'];
    ...
    getLineWidth() {
        const lineWidth = window.getComputedStyle(this.element)['line-width'];
        return parseFloat(lineWidth);
    }

    fit() {
        //this.element.innerHTML = this.txt;
        const element_height = this.height;
