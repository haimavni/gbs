...
export class StoryDetail {
    ...
    constructor(
        ...
        @IArticleList private readonly article_list: IArticleList,
        ...
        @IShowPhoto private readonly show_photo: IShowPhoto
    ) {
    ...
    attached() {
        ...
        this.subscriber = this.eventAggregator.subscribe(
            ...
            (payload: any) => {
                ...
                let photo_ids = payload.slide_list.map(
    ...
    update_associated_members() {
        ...
        this.dialog
            ...
            .whenClosed((response) => {
                ...
                let member_ids = Array.from((response.value as any).member_ids);
    ...
    update_associated_articles() {
        ...
        this.dialog
            ...
            .whenClosed((response) => {
                this.theme.hide_title = false;
                if (response.status !== "ok") return;
                let article_ids = Array.from(
                    (response.value as any).article_ids
                );
    ...
    update_associated_photos() {
        ...
        this.dialog
            ...
            .whenClosed((response) => {
                ...
                photo_ids = (response.value as any).associated_photos;
                this.api
