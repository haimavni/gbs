...
export class HitCountsNew {
    ...
    get curr_totals() {
        ...
        console.log(
            "entered curr totals. this.itemized_counts ",
            this.itemized_counts
        );
        if (!this.itemized_counts) return 0;
        console.log(
            "this.itemized_counts[this.curr_what].totals ",
            this.itemized_counts[this.curr_what].totals
        );
    ...
    calc_count_list() {
        console.log(
            "detailed: ",
            this.itemized_counts[this.curr_what].detailed
        );
        this.items =
            this.itemized_counts[this.curr_what].detailed[this.curr_period];
    }
}
